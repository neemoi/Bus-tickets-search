...
namespace Persistance.EntityFluentAPI
{
    internal class RouteConfiguration : IEntityTypeConfiguration<Route>
    {
        public void Configure(EntityTypeBuilder<Route> entity)
        {
            ...
            entity.HasIndex(e => e.SheduleId, "fk_shedule_idx");
            ...
            entity.Property(e => e.DriverId).HasColumnName("fk_driver");
            entity.Property(e => e.SheduleId).HasColumnName("fk_shedule");
            entity.Property(e => e.TransportId).HasColumnName("fk_transport");
